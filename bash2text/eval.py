...
#this line appears frequently in the aforementioned RedCode eval file. simply a string comparison
...
#using regex expressions to see if the standalone word is found
